...
from schemas import TokenTracker, Reviewer, QAPair, Paper


class QuestionState(BaseModel):
    messages: Annotated[Sequence[BaseMessage], add_messages] = Field(None,
                                                                     description="Sequence of messages related to the "
                                                                                 "question state")
    ...
    reviewers: Sequence[Reviewer] = Field(None, description="Sequence of reviewers selected")
    token_usage: TokenTracker = Field(None, description="Token usage for the question state")
    questions: Annotated[Sequence[str], add] = Field(None, description="Sequence of queries related to the question "
                                                                       "state")
    model_config = {
...
class AnswerState(BaseModel):
    ...
    questions: Annotated[Sequence[str], add] = Field(None, description="Sequence of questions related to the answer state")
    answers: Annotated[Sequence[str], add] = Field(None, description="Final 'YES' or 'NO' answer to each question")
...
class SingleQuery(BaseModel):
    ...
    sub_queries: Annotated[Sequence[QAPair], add] = Field(None,
                                                      description="Sequence of sub queries related to the single query")
